        ...
        for i, data_batch in enumerate(data_loader):
            ...
            for _t in range(3):
                ...
                if _t != 2:
                    ...
                    pgd.restore_grad()
                outputs = model(bert_inputs, grid_mask2d, dist_inputs, pieces2word, sent_length)
                adv_loss = self.criterion(outputs[grid_mask2d], grid_labels[grid_mask2d])
                adv_loss.backward()
            pgd.restore()
...
if __name__ == '__main__':
    ...
    parser.add_argument('--config', type=str, default='./config/gaiic_nehza.json')
