...
def main():
    ...
    parser.add_argument('--seed', default=1234, type=int)  # 随机种子
    parser.add_argument('--gpu', default='0', type=str) # gpu deviceid
    parser.add_argument('--epochs', default=50, type=int) # 训练轮数
    parser.add_argument('--batch_size', default=32, type=int) # 4 8 16
    parser.add_argument('--embedding_size', default=128, type=int) # 64 128 256/50 100 200
